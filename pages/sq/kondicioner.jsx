    ...
    <div>
      ...
      <div className={styles.Desktop}>
        <div className={styles.plumber}>
          ...
          <h1 className={styles.ps1}> KONDICIONER</h1>
        </div>
        <div className={styles.text}>
          <span className={styles.head1}>
            <span className={styles.head2}> KONDICIONER</span>
          </span>
        </div>
        <div className={styles.span}>
          <span className={styles.span1}>
            {" "}
            Ne kemi ofruar shërbime të cilësisë së lartë të ajrit të
            kondicionuar për banesa dhe klientët komercialë. Inxhinierët tanë të
            ditur kanë krijuar përvojë e gjerë me punë të të gjitha llojeve dhe
            madhësive, duke ofruar zgjidhje efektive me një çmim konkurrues – pa
            pasur nevojë për një kontratë në vazhdim ose tarifë thirrjeje. e
            gjithë puna jonë ka përfunduar në mënyrë të sigurtë, efikase dhe
            profesionale, duke mbajtur ndërprerjen në a minimale dhe largimi i
            mundimit nga adresimi i çështjeve.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.ma}>
          ...
          <span className={styles.ma1}> KONDICIONER </span>
