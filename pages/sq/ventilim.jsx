...
const Ventilation = () => {
  ...
  return (
    <div>
      <Head>
        <title>Ventilim ne maqedoni</title>
        <meta
          name="description"
      ...
      <div className={styles.Desktop}>
        <div className={styles.plumber}>
          ...
          <h1 className={styles.ps1}> VENTILIM</h1>
        </div>
        <div className={styles.text}>
          <span className={styles.head1}>
            <span className={styles.head2}> VENTILIM</span>
          </span>
        </div>
        <div className={styles.sp}>
          <span className={styles.sp1}>
            ne mund të ndihmojmë në projektimin, instalimin, riparimin dhe
            zëvendësimin e kushteve të ajrit, duke i vënë në përdorim aftësitë
            tona si art i projektit tuaj të përmirësimit. Ne kemi punuar me
            sukses në kushtet e ajrit të të gjitha madhësive brenda një gamë të
            gjerë të pronave dhe do të jetë në gjendje të sigurojë çdo ekspert
            ndihmën që ju kërkoni. Ne jemi të përgatitur për të trajtuar çdo
      ...
      <div className={styles.Mobile}>
        <div className={styles.mv}>
          ...
          <span className={styles.mv1}> VENTILIM </span>
