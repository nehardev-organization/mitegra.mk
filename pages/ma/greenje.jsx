      ...
      <div className={styles.Desktop}>
        ...
        <div className={styles.span}>
          <span className={styles.span1}>
            ...
            комерцијални клиенти. Нашите упатени инжињенери за греење изградија
            долгогодишно искуство со работни места од сите видови и големини,
            обезбедувајќи ефективни решенија по конкурентна цена. Како стручњаци
            за греење, со нашата работа ке ви биде завршена безбедно, ефикасно и
            професионално.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.mh}>
          ...
          <h1 className={styles.mh2}>
            Обезбедивме висококвалитетни услуги <br />
            за греење на станбени и комерцијални <br />
            клиенти. Нашите упатени инжињенери за <br />
            греење изградија долгогодишно искуство <br />
            со работни места од сите видови и <br />
            големини, обезбедувајќи ефективни решенија
            <br />
            по конкурентна цена. Како стручњаци за <br />
            греење, со нашата работа ке ви биде завршена <br />
            безбедно, ефикасно и професионално.
          </h1>
        </div>
