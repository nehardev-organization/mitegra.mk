      ...
      <div className={styles.Mobile}>
        <div className={styles.mh}>
          ...
          <h1 className={styles.mh2}>
            ...
            и технологии, како и светските стандарди и трендови ги имплементира
            во своето секојдневно работење. Претходното искуството на
            менаџментот, стекнувано низ текот на годините во некои од водечките
            фирми во Италија. овозможува компанијата да се специјализира
            запроектирање и изведба на комплетни технички решенија и одржување
            на инсталации
          </h1>
        </div>
