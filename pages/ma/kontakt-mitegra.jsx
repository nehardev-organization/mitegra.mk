      ...
      <div className={styles.Mobile}>
        <div className={styles.mh}>
          ...
          <h1 className={styles.mh2}>
            Ние сме компанија која постојано го <br />
            следи развојот на нови решенија
            <br />
            и технологии, како и светските <br />
            стандарди и трендови ги имплементира
            <br />
            во своето секојдневно работење.
            <br />
            Претходното искуството на
            <br />
            менаџментот, стекнувано низ текот
            <br />
            на годините во некои од водечките
            <br />
            фирми во Италија. овозможува компанијата
            <br />
            да се специјализира запроектирање и <br />
            изведба на комплетни технички решенија
            <br />и одржување на инсталации
          </h1>
        </div>
