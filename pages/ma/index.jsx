      ...
      <div className={styles.Mobile}>
        <div className={styles.mp}>
          ...
          <h1 className={styles.mp2}>
            Нашите одобрени водоводџии можат да ви <br />
            помогнат со целиот водоводбарања, <br />
            обезбедувајќи ефикасен одговор на прашањ
            <br />
            како што се протекување и други проблеми.
            <br />
            Со нивното долгогодишно искуство, нашиот <br />
            тим исто така може да изврши широк спектар <br />
            на професионални услуги за инсталација на водовод.
          </h1>
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mc2}>
            Можеме да понудиме комплетен дизајн, <br />
            производство и инсталирање на сите
            <br />
            начини на сплит воздух системи за <br />
            климатизација и единици за ракување <br />
            со канален воздух . Ѕидните сплит <br />
            системи се дизајниран за климатизација
            <br />
            на мали и средни области и се идеални
            <br />
            за канцелариски, продавници или домашни
            <br />
            простории, Тие обично се управуваат со
            <br />
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mb2}>
            Како искусни водоводџии, можеме да
            <br />
            помогнеме при дизајнирање, монтирње <br />
            и поправка на тоалетот, искористувајќи <br />
            ги нашите вештини на добра употреба <br />
            како дел од проектот за подобрување <br />
            на вашиот дом . Успешно сме работиле <br />
            на бањи од сите големини во широк опсег.
            <br />
            Подготвени сме да се справиме со какви
            <br />
            било прашања или предизвици со кои се
            <br />
            среќаваме.
          </h2>
          <Link href="/ma/banja">
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mv2}>
            ...
            инсталирање, поправка и замена
            <br />
            на Air Услови, искористувајќи ги
            <br />
            нашите вештини како дел од вашиот
            <br />
            проект за подобрување. Ние успешно <br />
            работевме на Air услови од сите
            <br />
            големини во широк опсег на својства <br />
            и ќе можеме да обезбедиме било
            <br />
