      ...
      <div className={styles.Desktop}>
        <div className={styles.imc2}>
          ...
          <h2 className={styles.Ph2}>
            ...
            <br /> протекување, блокади и скршени тоалети.Со нивното <br />{" "}
            долгогодишно искуство, нашиот тим исто така може да изврши <br />{" "}
            широк спектар на професионални услуги за инсталација на водовод,{" "}
        ...
        <div className={styles.imc3}>
          ...
          <h2 className={styles.hH2}>
            ...
            за дали тие се добри <br /> погодни за вашиот дом. Ние исто така
            издаваме
            <br /> професионални извештаи на купувачите и <br />
            услуги кои се фокусираат на <br /> здравјето на вашиот централен
            систем на греење.
          </h2>
