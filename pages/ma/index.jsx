    ...
    <div className={styles.HomePage}>
      ...
      <div className={styles.imc1}>
        ...
        <h1 className={styles.h1}>
          Работиме со компании за недвижнини кои имаат потреба за безбедни и
          здрави хидраулични услуги
        </h1>
      </div>
      <div className={styles.Desktop}>
        ...
        <div className={styles.imc5}>
          ...
          <h2 className={styles.bH2}>
            Како искусни водоводџии, можеме да <br />
            помогнеме при дизајнирање, монтирње
            <br />
            и поправка на тоалетот, искористувајќи
            <br />
            ги нашите вештини на добра употреба како
            <br />
            дел од проектот за подобрување на вашиот
            <br />
            дом . Успешно сме работиле на бањи од сите
            <br />
            големини во широк опсег. Подготвени сме да <br />
            се справиме со какви било прашања или <br />
            предизвици со кои се среќаваме.
          </h2>
          <Link href="/ma/banja">
        ...
        <div className={styles.imc6}>
          ...
          <h2 className={styles.bv2}>
            Можеме да помогнеме во дизајнирање, <br />
            инсталирање, поправка и замена на <br />
            Air Услови, искористувајќи ги нашите
            <br />
            вештини како дел од вашиот проект за
            <br />
            подобрување. Ние успешно работевме на
            <br />
            Air услови од сите големини во широк <br />
            опсег на својства и ќе можеме да обезбедиме
            <br />
            било каква стручна помош што ви треба.
          </h2>
      ...
      <div className={styles.Mobile}>
        <div className={styles.mp}>
          ...
          <h1 className={styles.mp2}>
            Нашите одобрени водоводџии можат да ви помогнат со целиот
            водоводбарања, обезбедувајќи ефикасен одговор на прашањ како што се
            протекување и други проблеми. Со нивното долгогодишно искуство,
            нашиот тим исто така може да изврши широк спектар на професионални
            услуги за инсталација на водовод.
          </h1>
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mht1}>
            Обезбедуваме специјални услуги за греење кои ги промовираат голем
            број на алтернативно греење. Нашите инженери можат да воведат
            придобивки од подното греење и интерфејс единици, кои ви помагаат да
            донесете одлука за дали тие се добри и погодни за вашиот дом. Ние
            исто така издаваме професионални извештаи на купувачите и услуги кои
            се фокусираат на вашиот централен систем за греење.
          </h2>
          <Link href="/ma/greenje">
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mc2}>
            Можеме да понудиме комплетен дизајн, производство и инсталирање на
            сите начини на сплит воздух системи за климатизација и единици за
            ракување со канален воздух . Ѕидните сплит системи се дизајниран за
            климатизација на мали и средни области и се идеални за канцелариски,
            продавници или домашни простории, Тие обично се управуваат со
            далечински управувач. инфра-црвена контрола.
          </h2>
          <Link href="/ma/klimatizacija">
        ...
        <div className={styles.mp}>
          ...
          />
          <div className={styles.mheb}></div>
          <h1 className={styles.mb1}>БАЊА</h1>
          <h2 className={styles.mb2}>
            Како искусни водоводџии, можеме да помогнеме при дизајнирање,
            монтирње и поправка на тоалетот, искористувајќи ги нашите вештини на
            добра употреба како дел од проектот за подобрување на вашиот дом .
            Успешно сме работиле на бањи од сите големини во широк опсег.
            Подготвени сме да се справиме со какви било прашања или предизвици
            со кои се среќаваме.
          </h2>
          <Link href="/ma/banja">
            <button className={styles.mbButton}>БАЊА</button>
          </Link>
        </div>
        <div className={styles.spacer}>
          <span></span>
        ...
        <div className={styles.mp}>
          ...
          <h2 className={styles.mv2}>
            ...
            на Air Услови, искористувајќи ги нашите вештини како дел од вашиот
            проект за подобрување. Ние успешно работевме на Air услови од сите
            големини во широк опсег на својства и ќе можеме да обезбедиме било
            каква стручна помош што ви треба.
          </h2>
          <Link href="/ma/ventilicija">
