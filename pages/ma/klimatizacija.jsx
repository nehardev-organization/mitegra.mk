      ...
      <div className={styles.Desktop}>
        ...
        <div className={styles.span}>
          <span className={styles.span1}>
            ...
            искуство со работни места од сите видови и големини, обезбедувајќи{" "}
            ефективни решенија по конкурентна цена – без потреба од тековен
            договор или наплата на повик. целата наша работа е завршена
            безбедно, ефикасно и професионално, задржувајќи го нарушувањето на a
            минимум и отстранување на маката од решавање на проблемите.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.ma}>
          ...
          <h1 className={styles.ma2}>
            Обезбедивме висококвалитетни услуги за климатизација на станбени{" "}
            <br />и комерцијални клиенти. Нашите упатени инженери изградија{" "}
            <br />
            долгогодишно искуство со работни места од сите видови и големини,
            обезбедувајќи <br />
            ефективни решенија по конкурентна цена – без потреба од <br />
            тековен договор или наплата на повик. целата наша работа е завршена
            безбедно, <br />
            ефикасно и професионално, задржувајќи го прекинот на минимум и{" "}
            <br />
            отстранување на мака од решавање на прашања.
          </h1>
        </div>
