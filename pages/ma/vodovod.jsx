      ...
      <div className={styles.Desktop}>
        ...
        <div className={styles.span}>
          <span className={styles.span1}>
            ...
            услуги. Нашиот тим од одобрени експерти за водовод е воспостави
            долгогодишно практично искуство со станбена и комерцијална работа од
            сите видови и големини, нудејќи квалитетни услуги високо по поволна
            цена и без надомест за повик. допаѓа професионалци, ги отстрануваме
            проблемите од водоводните проблеми и проекти за подобрување на
            домот, работејќи ефикасно за тоа минимизирајте ги прекините и
            заштедете време и пари. Без оглед на природата на вашиот проект, ние
            ја имаме таа способност, знаење и стручност за да го постигнете
            резултатот вие и имотот вашите бара.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.mp}>
          ...
          <h1 className={styles.mp2}>
            ...
            <br />
            услуги. Нашиот тим од одобрени експерти за водовод е {""}
            <br />
            воспостави долгогодишно практично искуство со станбена и
            комерцијална работа {""}
            <br />
            од сите видови и големини, нудејќи квалитетни услуги {""}
            <br />
            високо по поволна цена и без надомест за повик. Ако <br />
            професионалци, ги отстрануваме проблемите од водоводните проблеми и{" "}
            {""}
            <br />
            проекти за подобрување на домот, кои работат ефикасно на {""}
            <br />
            минимизирајте ги прекините и заштедете време и пари. <br />
            Без оглед на природата на вашиот проект, ние ја имаме таа
            способност, {""}
            <br />
            знаење и експертиза за да го постигнете резултатот вие и имотот {""}
            <br />
            вашите бара.
          </h1>
        </div>
