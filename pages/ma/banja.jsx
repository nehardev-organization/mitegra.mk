    ...
    <div>
      ...
      <div className={styles.Desktop}>
        <div className={styles.plumber}>
          ...
          <h1 className={styles.ps1}> ПОСТАВУВАЊЕ НА БАЊА</h1>
        </div>
        <div className={styles.text}>
          <span className={styles.head1}>
            <span className={styles.head2}> ПОСТАВУВАЊЕ НА БАЊА</span>
          </span>
        </div>
        <div className={styles.span}>
          <span className={styles.span1}>
            Нашите искусни и одобрени водоводџии даваат одговор на брзо во
            тоалет прашања и прашања. Ако сте испланирајте комплетен проект за
            реновирање на бања или имате потреба од стручни работи за поправка
            се соочуваме со истекување или блокада, нашиот тим има вештини и
            знаења да помогне. Нашите водоводџии се справуваат со сè,
            отстранувајќи ја маката што ја имаат направи со инсталација или
            одржување на бањата и обезбедување на а Ефикасна и висококвалитетна
            услуга без повик или наплата тековен договор.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.mb}>
          ...
          <span className={styles.mb1}> ПОСТАВУВАЊЕ НА БАЊА</span>
          <h1 className={styles.mb2}>
            Нашите искусни и одобрени водоводџии даваат одговор
            <br /> прашања и прашања за брзо во тоалет. Ако сте војвода
            <br />
            испланирајте целосен проект за реновирање бања или имајте
            <br />
            треба стручна поправка, се соочуваме со истекување
            <br />
            или блокада, нашиот тим има вештини и знаења да помогне. <br />
            Нашата хидраулика се справува со сè, отстранувајќи ги неволјите што
            треба да ги
            <br />
            направи инсталација или одржување на бања и обезбедување на
            <br />
            Ефикасна и висококвалитетна услуга без повик или "tar тарифа
            <br />
            тековен договор.
          </h1>
        </div>
