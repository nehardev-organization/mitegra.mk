...
const Ventilation = () => {
  ...
  return (
    <div>
      <Head>
        <title>Најдобра вентилација во Северна Македонија </title>
        <meta
          name="description"
      ...
      <div className={styles.Desktop}>
        <div className={styles.plumber}>
          ...
          <h1 className={styles.ps1}> ВЕНТИЛАЦИЈА</h1>
        </div>
        <div className={styles.text}>
          <span className={styles.head1}>
            <span className={styles.head2}> ВЕНТИЛАЦИЈА</span>
          </span>
        </div>
        <div className={styles.sp}>
          <span className={styles.sp1}>
            Можеме да помогнеме во дизајнирање, поправка и замена на климатските
            услови, добро да ги искористиме нашите вештини како уметност на
            вашиот проект за подобрување. Успешно работиме на климатизација од
            сите големини во рамките на широк спектар на својства и решавање за
            секоја помош што ви треба. Подготвени сме да се справиме со какви
            било прашања или предизвици.
          </span>
        </div>
      ...
      <div className={styles.Mobile}>
        <div className={styles.mv}>
          ...
          <span className={styles.mv1}> ВЕНТИЛАЦИЈА </span>
          <h1 className={styles.mv2}>
            Можеме да помогнеме во дизајнирање, <br />
            поправка и замена на климатските <br />
            услови, добро да ги искористиме <br />
            нашите вештини како уметност на <br />
            вашиот проект за подобрување. Успешно <br />
            работиме на климатизација од сите <br />
            големини во рамките на широк спектар <br />
            на својства и решавање за секоја <br />
            помош што ви треба. Подготвени сме да <br />
