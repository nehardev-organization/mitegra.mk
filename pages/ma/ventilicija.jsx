      ...
      <div className={styles.Mobile}>
        <div className={styles.mv}>
          ...
          <h1 className={styles.mv2}>
            Можеме да помогнеме во дизајнирање, поправка и замена <br />
            на климатските услови, добро да ги искористиме нашите вештини како
            <br />
            уметност на вашиот проект за подобрување. Успешно работиме на
            <br />
            климатизација од сите големини во рамките на широк спектар на
            <br />
            својства и решавање за секоја помош што ви треба.
            <br />
